...
from tools.assertions.files import asser_create_file_response, assert_get_file_response, \
...
class TestFiles:
    ...
    def test_create_file(self, files_client:FilesClient):
        ...
        asser_create_file_response(request, response_data)
    ...
    @allure.title("Получение файла с некорректным файл айди ")
