...
class APIClient:
    ...
    @allure.step("Делаем GET запрос по {url}")
    ...
    @allure.step("Делаем POST запрос по {url}")
    def post(self,
             url: URL | str,
             json: Any,
    ...
    @allure.step("Делаем PATCH запрос по {url}")
    def patch(self,
             url: URL | str,
             json: Any
             ) -> Response:
    ...
    @allure.step("Делаем DELETE запрос по {url}")
